const DDay = {
    ...
    target: {
        x: 0,
        y: 0,
        width: CONFIG.tracking.dday.width,
        height: CONFIG.tracking.dday.height,
        vx: 0,
        vy: 0,
        speed: CONFIG.tracking.dday.speed
    },
    stats: {
        timeInside: 0,
        totalTime: 0,
    ...
    directionChange: {
        min: CONFIG.tracking.dday.directionChangeMin,
        max: CONFIG.tracking.dday.directionChangeMax,
        nextChange: 0
    },
    mouseInside: false,
    animationFrame: null,
